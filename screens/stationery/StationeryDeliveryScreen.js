...
export default function StationeryDeliveryScreen() {
  const navigation = useNavigation();
  const resturant = useSelector(selectResturant);
  const dispatch = useDispatch();
  const handleCancel = () => {
    dispatch(emptyBasket());
    navigation.navigate('StationeryHomeScreen');
  };
  return (
    <View className="flex-1">
      ...
      <View className="rounded-t-3xl mt-12 bg-white relative flex flex-col justify-center items-center">
